...
import com.udea.serviciosretsudea.modelo.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.serviciosretsudea.modelo.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.mycompany_serviciosRetsUdea_war_1.0-SNAPSHOTPU")
